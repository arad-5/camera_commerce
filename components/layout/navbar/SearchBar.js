...
const SearchBar = () => {
    ...
    return (
        <div className='items-center min-w-[2.5rem] h-10 hover:shadow-md transition-shadow rounded-full flex sm:dark:bg-neutral-900 border sm:bg-neutral-100 justify-center'>
